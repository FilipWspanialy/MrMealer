...
@dso_cache = dso_local local_unnamed_addr global [730 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 235580896, ; hash 0xe0aade0, from name: MrMealer.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 490905861, ; hash 0x1d42a105, from name: aot-MrMealer.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-MrMealer.dll.so
		ptr null; void* handle (0x0)
	}, ; 79
	...
	%struct.DSOCacheEntry {
		i64 642071485, ; hash 0x26453bbd, from name: libaot-MrMealer.Database
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 994640506, ; hash 0x3b49027a, from name: MrMealer
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-MrMealer.dll.so
		ptr null; void* handle (0x0)
	}, ; 161
	...
	%struct.DSOCacheEntry {
		i64 1095435907, ; hash 0x414b0683, from name: aot-MrMealer.Database
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MrMealer.Database.dll.so
		ptr null; void* handle (0x0)
	}, ; 178
	...
	%struct.DSOCacheEntry {
		i64 2010876531, ; hash 0x77db8a73, from name: libaot-MrMealer
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-MrMealer.dll.so
		ptr null; void* handle (0x0)
	}, ; 337
	...
	%struct.DSOCacheEntry {
		i64 2118968426, ; hash 0x7e4ce46a, from name: libaot-MrMealer.Database.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MrMealer.Database.dll.so
		ptr null; void* handle (0x0)
	}, ; 362
	...
	%struct.DSOCacheEntry {
		i64 2194177291, ; hash 0x82c87d0b, from name: MrMealer.Database.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MrMealer.Database.dll.so
		ptr null; void* handle (0x0)
	}, ; 376
	...
	%struct.DSOCacheEntry {
		i64 2848290413, ; hash 0xa9c5766d, from name: libaot-MrMealer.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-MrMealer.dll.so
		ptr null; void* handle (0x0)
	}, ; 491
	...
	%struct.DSOCacheEntry {
		i64 3445393933, ; hash 0xcd5c8a0d, from name: aot-MrMealer.Database.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MrMealer.Database.dll.so
		ptr null; void* handle (0x0)
	}, ; 585
	...
	%struct.DSOCacheEntry {
		i64 3922226020, ; hash 0xe9c86b64, from name: MrMealer.Database
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MrMealer.Database.dll.so
		ptr null; void* handle (0x0)
	}, ; 661
	...
	%struct.DSOCacheEntry {
		i64 3936021036, ; hash 0xea9aea2c, from name: aot-MrMealer
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-MrMealer.dll.so
		ptr null; void* handle (0x0)
	}, ; 668
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [151 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4
