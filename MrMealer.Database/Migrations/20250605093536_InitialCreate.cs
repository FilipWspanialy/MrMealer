    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecipeForMeals", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RecipeForMeals_Meals_MealId",
                        column: x => x.MealId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ingredients_RecipeForMeals_RecipeForMealId",
                        column: x => x.RecipeForMealId,
                        principalTable: "RecipeForMeals",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ingredients_RecipeForMealId",
                table: "Ingredients",
                column: "RecipeForMealId");
